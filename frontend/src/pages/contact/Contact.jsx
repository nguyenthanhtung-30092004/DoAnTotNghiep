          ...
          <div className="max-w-md">
            <RevealStagger>
              ...
              <p className="text-muted-foreground text-lg mb-12">
                Dù bạn có câu hỏi về sản phẩm, cần hỗ trợ kỹ thuật hay muốn hợp
                tác, đội ngũ của chúng tôi luôn sẵn sàng lắng nghe.
              </p>
            </RevealStagger>
              ...
              <RevealStagger delay={0.2}>
                <div>
                  ...
                  <p className="text-lg mb-1">
                    <a
                      href="mailto:tungnt2k4yyy@gmail.com"
              ...
              <RevealStagger delay={0.3}>
                <div>
                  ...
                  <p className="text-lg text-muted-foreground">
                    Thứ Hai - Thứ Sáu, 9:00 sáng đến 6:00 chiều.
                  </p>
                </div>
              </RevealStagger>
            </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Chúng tôi không chia sẻ thông tin của bạn với bên thứ
                        ba.
                      </p>
                    </div>
