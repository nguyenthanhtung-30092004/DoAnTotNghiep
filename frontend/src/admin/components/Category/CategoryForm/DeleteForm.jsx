...
const DeleteForm = ({ onClose, onConfirm, category }) => {
    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-slate-950/50 px-4 backdrop-blur-sm">
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl">
        <div className="flex items-start gap-4 px-6 pt-6">
          ...
          <div className="pr-8">
            <h2 className="text-xl font-bold text-slate-900">Xóa danh mục</h2>
        ...
        <div className="mx-6 mt-5 rounded-xl border border-red-100 bg-red-50 px-4 py-3">
          <p className="text-sm leading-6 text-red-600">
            Hành động này không thể hoàn tác. Nếu danh mục đang có danh mục con,
            hệ thống sẽ không cho phép xóa.
          </p>
        </div>
